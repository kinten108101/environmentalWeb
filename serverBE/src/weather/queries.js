...
const addEmployee="INSERT INTO EMPLOYEE (ssn, fname, minit, lname, stationid, bdate, phonenumber) VALUES ($1, $s2, $s3, $4, $5, $6, $7)"
const checkUuidExist ="SELECT * FROM REPORT WHERE uuid = $1"
const AddReport="INSERT INTO REPORT (uuid, timestamp, temperature, velox, veloy, veloz, essn, stationid) VALUES ($1, $s2, $s3, $4, $5, $6, $7, $s8)"
